...
* A front-end web app in Python which lets you add marks of various components of a student
* A Redis queue which collects new marks-data of students
* A Java worker which consumes marks, calculates result and stores them in…
* A Postgres database backed by a Docker volume
* A Node.js webapp which shows the student's result out of 100 in real time
...
It's a simple example of the various types of pieces and languages you might see (queues, persistent data, etc), and how to deal with them in Docker at a basic level.
